...
import {calculateEdgeTextAngle, getLineRectangleIntersection, getTextDimensions, type GraphEdge, type GraphNode} from "../graph_utils";
 ...
 */
export const GraphEdgeComponent = React.memo(({ edge, nodeLookupMap, isTop = false}: { edge: GraphEdge; nodeLookupMap: Map<string, GraphNode>, isTop?: boolean}) => {
