...
import {trueClass, falseClass, numberClass, procedureClass, arrayClass} from './wax_classes.tsx'
import {Compiler} from './compiler.ts'
import {add, getJsObjectProperty, getJsObjectPropertyForLiteral, getVariable, greaterThan, invokeProcedure, jump, jumpIfFalse, lessThan, pop, pushReturnValue, returnFromProcedure, setVariable} from './compiled_instructions.ts'
...
procedureClass.defineMethod('whileTrue', new CompiledProcedure({
...
arrayClass.defineMethod('length', new CompiledProcedure({
  id: "Array_length",
  instructions: [
...
})).defineMethod('at:', new CompiledProcedure({
  id: "Array_at",
  instructions: [
